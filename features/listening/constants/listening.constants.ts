...
} satisfies Record<ListeningSourceType, string>;
...
export const LISTENING_PRACTICE_MODE_LABELS = {
  ...
  shadowing: "Shadowing",
} satisfies Record<ListeningPracticeMode, string>;
...
export const LISTENING_ACCENT_LABELS = {
  ...
  mixed: "ترکیبی",
  unknown: "نامشخص",
} satisfies Record<ListeningAccent, string>;

export const LISTENING_CONTENT_STATUS_LABELS = {
  ready: "آماده تمرین",
  processing: "در حال آماده‌سازی",
  coming_soon: "به‌زودی",
} satisfies Record<ListeningContentStatus, string>;
...
export const LISTENING_DEFAULT_REWIND_SECONDS = 5;
...
export const LISTENING_NOTES_ACCEPT = Object.keys(
