...
type ListeningErrorProps = Readonly<{
  error: Error & {
    digest?: string;
  };
...
export default function ListeningError({
  ...
  useEffect(() => {
    console.error("Listening page error:", {
      name: error.name,
  ...
  return (
    ...
    >
      <section
        role="alert"
        aria-labelledby="listening-error-title"
        className="
          w-full rounded-3xl
      ...
      >
        ...
        <h1
          id="listening-error-title"
          className="mt-6 text-2xl font-bold text-white"
        >
          بخش شنیداری بارگذاری نشد
        </h1>

        <p className="mx-auto mt-3 max-w-lg text-sm leading-7 text-slate-400">
          دریافت محتوای شنیداری با مشکل مواجه شده است.
          ممکن است این خطا موقتی باشد؛ دوباره تلاش کن.
        </p>
