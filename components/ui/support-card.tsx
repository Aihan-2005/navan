...
import { LifeBuoy, MessageCircle, Mail, Phone, ChevronDown, ChevronUp } from "lucide-react";
      ...
      >
        ...
        <div className="relative">
          <button
            ...
            aria-controls="support-contact-info"
          >
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-2">
                <span
                  className="
                    ...
                    rounded-lg bg-white/10 text-cyan-100
                  "
                >
                ...
                <div className="text-right">
                  ...
                  <p className="mt-1 text-[10px] leading-5 text-cyan-100/80">
              ...
              {isExpanded ? (
                <ChevronUp aria-hidden="true" className="h-4 w-4 text-cyan-100/60" />
              ) : (
                <ChevronDown aria-hidden="true" className="h-4 w-4 text-cyan-100/60" />
              )}
            </div>
          </button>
          ...
          {isExpanded && (
            ...
            >
              <p className="mb-3 text-xs leading-6 text-cyan-100/80">
